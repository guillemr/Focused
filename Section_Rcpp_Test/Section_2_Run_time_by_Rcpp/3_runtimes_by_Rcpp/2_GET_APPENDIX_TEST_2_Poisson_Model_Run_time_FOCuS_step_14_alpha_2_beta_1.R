#-----------------------------------------------------------------------------|
# APPENDIX D.2 Empirical run times of MdFOCuS0 and MdFOCuS                    |
#-----------------------------------------------------------------------------|

################################################################################
##      TEST 2: Empirical Time Complexity of MdFOCuS by Rcpp                  ##
##    p-variate Independent Poisson Model without change (p =1,..,5)          ##
################################################################################


# Test description--------------------------------------------------------|
# We generate ts ~ P(1p) in dimension p = 1,.., 5                         | 
...
# 'APPENDIX_Runtime_step_15_alpha_2_beta_1_P_2_FOCuS_poisson_it_100.txt'  |
