#-----------------------------------------------------------------------------|
# SECTION      2.2 Bound on The Number of changepoint Candidates              |
#                                                                             |
#-----------------------------------------------------------------------------|

################################################################################
## TEST 1: CONVEX HULL. Facet and vertex number. Estimations                  ##
##           p-variate Independent Gaussian Model (p =1,..,5)                 ##
################################################################################
...
# 'Vs_dim_p_gauss_nbSimus_.txt'(for vertices)                              |                                                 |
#-------------------------------------------------------------------------|
...
for (p in 1 : length(dim_)) {
  ...
  write.table(data.frame (n = get_n, fs=get_fs), 
              paste('Fs_dim',dim_[p],'gauss',nbSimus_,'.txt',sep = '_'),
              row.names = TRUE, col.names = FALSE)
  write.table(data.frame (n = get_n, vs=get_vs),
              paste('Vs_dim',dim_[p],'gauss', nbSimus_,'.txt',sep = '_') , 
              row.names = TRUE, col.names = FALSE)
}
